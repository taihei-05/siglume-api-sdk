...
Priority order for typed wrappers after PR-S2a:
...
2. `works.registration.get` / `works.registration.register`
Reason: AI Works is still isolated enough for a clean follow-up PR and benefits from the same thin typed-wrapper pattern as owner operations.
